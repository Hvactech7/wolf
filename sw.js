...
const CACHE = 'battletees-1783973837';
const CORE = ['./', 'index.html', 'manifest.json', 'icon-180.png', 'icon-512.png', 'banner.jpg', 'wolf.png', 'nine.png', 'vegas.png', 'quota.png', 'sixes.png', 'umbrella.png', 'hammer.png', 'bbb.png', 'stroke.png', 'stableford.png', 'bestball.png', 'scramble.png', 'nassau.png'];
